  ...
  return (
    <div className="filter__bar-container">
      ...
      <div className={`filter__bar-wrapper ${addClass ? "active" : ""}`}>
        ...
        <form
          onSubmit={handleFilterByTempSubmit}
          className="filter__bar-form form-box"
          data-testid="form-1"
        >
          ...
          <datalist id="temperaments">
            {temps.map((temp) => (
              <option key={temp.id} value={temp.name}></option>
            ))}
          </datalist>
          <button type="submit">
        ...
        <div className="filter__bar-order form-box">
          ...
          <select onChange={handleOrderByWeigth}>
            <option value="" data-testid="weigth-option">
              Weigth
            </option>
            <option value="high" data-testid="weigth-option">
              Higher
            </option>
            <option value="low" data-testid="weigth-option">
              Lower
            </option>
          </select>
        </div>
